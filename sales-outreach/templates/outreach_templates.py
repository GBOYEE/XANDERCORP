    ...
    "intro": {
        ...
        <body style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
            ...
            <div style="padding: 30px; background: #fff;">
                ...
                <p>I help businesses like yours automate repetitive tasks with custom AI agents — the kind that run 24/7 and handle {pain_point}.</p>
                <p>Most clients save 10-20 hours per week after implementing one agent.</p>
